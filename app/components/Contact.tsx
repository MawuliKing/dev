  ...
  return (
    <section id="contact" className="mb-12">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <strong>Let's build something great together!</strong> Whether you have
        a project in mind, want to discuss tech, or just want to connect, feel
        free to reach out.
      </p>
      ...
      <div className="mt-3">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          Best regards, John Emil Modzaka
        </p>
      </div>
    </section>
  );
